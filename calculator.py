...
def cal():
    ...
    button15 = Button(root, text='C', bg=other_button_bg, padx=10, pady=3,
    ...
    button16 = Button(root, text='back', bg=other_button_bg, padx=10, pady=3,
